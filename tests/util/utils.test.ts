...
describe("sanitizeInput", () => {
    ...
    it("respects custom max length", () => {
        ...
        const longCurrencyName = "A very long currency name that exceeds fifty chars with these characters";
        expect(sanitizeInput(longCurrencyName, 50)).toBe("A very long currency name that exceeds fifty chars");
    });
    ...
    it("combines multiple sanitization rules", () => {
        const maliciousInput = "  \x00<script>alert('xss')\x1F</script>normal text\x7F  ";
